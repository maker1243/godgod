...
function render() {
  ...
  switch(state.scene) {
    ...
    case 'underground':  renderUnderground(); break;
...
function renderAcademy() {
  ...
  const doorCols = ['#ff6666', '#8bd8ff', '#c8b898', '#e8c547', '#c86ade', '#ff2d2d', '#ff00ff', '#ff0000', '#00c8ff', '#3ac762', '#ffefa8', '#c86ade', '#ff9c3d', '#c86ade', '#e8c547', '#c86ade', '#c86ade', '#ff2d2d', '#e8c547'];
