...
const ONBOARDING_PAGES = [
  ...
  { title:'축복과 상자, 콤보',
    lines:[
      '각 층 이동 시 3장 축복 카드 → 이번 런 유지되는 강력 효과.',
      '방 클리어 후 15% 확률 상자. [SPACE] 로 열어 랜덤 리워드.',
      '3초 안 연쇄 킬 = 콤보. 티어 진입 (3/5/10/20/40/80) 시 RP 보너스.',
      '무피격 방 클리어 = PERFECT! +100 RP.',
      '축복 3장 특정 조합 = 시너지 자동 발동 (SUNBLAZE 등 6종).',
    ] },
  { title:'영구 성장과 커스터마이즈',
    lines:[
      '[LEGACY] 문: 관록 (10 pillar) · 아티팩트 (30 종) · 트레잇 (20 종).',
      '[STYLE] 문: 로브/모자/별/트레일 커스터마이즈.',
      '[TRAIN] 문: 훈련장에서 자기 DPS 확인 + RP 획득.',
      'ELARA 유대 10 단계. 완료 시 ARCANA CROWN 아티팩트 획득.',
    ] },
  { title:'매일/매주 도전과 게임 모드',
    lines:[
      '매일 첫 접속: RP 지급 + 연속 접속 보너스 (7일 만점).',
      '매주 3가지 도전 (CODEX 의 WEEKLY 탭). 완료 시 큰 RP.',
      'CODEX 의 MODES 탭: IRONMAN, HARDCORE, ENDLESS 등 6종.',
      'CODEX 의 MEMORY 탭: 최근 하이라이트 20개 자동 저장.',
      '아카데미 좌상단 [?] 또는 [H] 로 이 도움말 재열람.',
    ] },
];
