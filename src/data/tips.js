...
const TIPS = [
  ...
  '희귀 상자 (파란색) 는 x2 보상, 전설 상자 (자주색) 는 x5!',
  '아침 이벤트 축제일 시 몹 처치 RP +50%.',
  'Sale Day 아침 이벤트 시 상점 포션 50% 할인.',
  'Blood Moon 아침 이벤트 시 픽업 드롭 x2.',
  '보스 킬 시 슬로우모션 + 화면 흔들림 + 폭발!',
  '보스 슬램 공격 전 붉은 원 (경고) 이 뜨니 회피!',
  'ENDLESS 모드는 층 무한. 층마다 몹 HP +30%.',
