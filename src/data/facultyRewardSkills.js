...
const FACULTY_REWARD_SKILLS = {
  humanities: {
    lmb: _frMk('fr_hum_lmb', '문학의 정수', 'lmb', 8000,
      shot('fire', {dmg:l=>150000, speed:400, r:3, life:1.2, count:6, spread:0.4, pierce:true, visual:'dept_hangeul'}), null,
      {cd:0.2, mp:5, desc:'한글 자소 6발 관통. 사기.', visual:'dept_hangeul', faculty:'humanities'}),
    q: _frMk('fr_hum_q', '언어의 시가', 'q', 15000,
      shot('ice', {dmg:l=>2500000, speed:280, r:5, life:2.5, count:4, spread:0.3, freeze:5, pierce:true, visual:'dept_ink_q'}), null,
      {cd:1.6, mp:35, desc:'구절 4발 파도. 5초 얼음.', visual:'dept_ink_q', faculty:'humanities'}),
    e: _frMk('fr_hum_e', '언어의 창조', 'e', 30000,
      shot('fire', {dmg:l=>50000000, speed:200, r:8, life:3, count:24, spread:6.28, explosive:true, explodeR:100, homing:true, visual:'dept_hangeul_e'}), null,
      {cd:10, mp:120, desc:'24방향 언어 창조. 5천만.', visual:'dept_hangeul_e', faculty:'humanities'}),
